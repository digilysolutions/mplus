...
return new class extends Migration
{
    ...
    {
        Schema::create('discounts_by_quantities', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            ...
            $table->integer('quantity');   //(la cantidad a partir de la cual se aplica el descuento)
    ...
    {
        Schema::dropIfExists('discounts_by_quantities');
    }
};
