<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="product_id" class="form-control @error('product_id') is-invalid @enderror" value="{{ old('product_id', $attributeProduct?->product_id) }}" id="product_id" placeholder="Product Id">
            ...
            <div class="checkbox">
                <label>
                    <input id="is_activated" name="is_activated" class="mr-2" type="checkbox"
                        ...
                        value="1" {{ old('is_activated', $attributeProduct?->is_activated) ? 'checked' : '' }}>
                    Activado
                </label>
            </div>
