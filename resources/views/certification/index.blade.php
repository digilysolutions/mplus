                                ...
                                <tbody>
                                 ...
                                 @endphp
                                    ...
                                    @foreach ($certifications as $certification)
										...
										<td >{{ $certification->is_activated }}</td>

                                            <td>
                                                <form action="{{ route('certifications.destroy', $certification->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('certifications.show', $certification->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Mostrar') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('certifications.edit', $certification->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Editar') }}</a>
                                                    @csrf
                                                    @method('DELETE')
