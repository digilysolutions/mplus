            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">{{ __('Update') }}  {{__('Delivery Zones')}}</span>
                ...
                @endif<div class="card-body bg-white">
                        <form method="POST" action="{{ route('delivery-zones.update', $deliveryZone->id) }}"  role="form" enctype="multipart/form-data" data-toggle="validator">
                            {{ method_field('PATCH') }}
                            @csrf
