            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">{{ __('Update') }} Product Category</span>
                ...
                @endif<div class="card-body bg-white">
                        <form method="POST" action="{{ route('product-categories.update', $productCategory->id) }}"  role="form" enctype="multipart/form-data" data-toggle="validator">
                            {{ method_field('PATCH') }}
                            @csrf
