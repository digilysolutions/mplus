<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $term?->name) }}" id="name" placeholder="{{ __('Name') }}">
            ...
            <div class="checkbox">
                <label>
                    <input id="is_activated" name="is_activated" class="mr-2" type="checkbox"
                        ...
                        value="1" {{ old('is_activated', $term?->is_activated) ? 'checked' : '' }}>
                    Activado
                </label>
            </div>
